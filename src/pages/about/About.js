                    ...
                    <div className="container">
                        <div className="menu" id="menu-perfil">
                            <div className="mini-card">
                                    <img src={Mirela} alt="imagem perfil Mirela" className="img-perfil-icone"></img>
                                    <p>Mirela De Giuli</p>
                            ...
                            <div className="mini-card">
                                <div>
                                    <img src={Pedro} alt="imagem perfil Pedro" className="img-perfil-icone"></img>
                                    <p>Pedro H. Borges</p>
                            ...
                            <div className="mini-card">
                                <div>
                                    <img src={Rafael} alt="imagem perfil Rafael" className="img-perfil-icone"></img>
                            ...
                            <div className="mini-card">
                                <div>
                                    <img src={Thiago} alt="imagem perfil Thiago" className="img-perfil-icone"></img>
                                    <p>Thiago Dutra</p>
                        ...
                        <div className="equipe-conteudo" id="equipe_conteudo">
                            ...
                            <div id="mirela" if= "pessoa == 'mirela' || isMobile == true">
                                <div className="card">
                                    <img src={BackgroundCard} alt="background card" className="card-img"></img>
                                    <img src={Mirela} alt="imagem perfil mirela" className="img-perfil-sobre"></img>
                                    ...
                                    <ul className="redes-sociais">
                                        <li><a href="https://github.com/mirelagiuli" target="_blank"><FontAwesomeIcon icon="faArrowUp"/></a></li>
                                        <li><a href="mailto:mireladegiuli@gmail.com"><i className="fas fa-envelope"></i></a></li>
                                        <li><a href="https://www.linkedin.com/in/mirela-de-giuli" target="_blank"><i className="fab fa-linkedin"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div id="pedro">
                                <div className="card" if= "pessoa == 'pedro' || isMobile == true">
                                    <img src={BackgroundCard} alt="background card" className="card-img"></img>
                                    <img src={Pedro} alt="imagem perfil pedro" className="img-perfil-sobre"></img>
                                    <h2>Pedro H. Borges</h2>
                                    <p className="introducao">Olá! Sou Pedro</p>

                                    <ul className="redes-sociais">
                                        <li><a href="https://github.com/pedrohrb7" target="_blank"><i className="fab fa-github"></i></a></li>
                                        <li><a href="mailto:pedrohenriquer77@hotmail.com"><i className="fas fa-envelope"></i></a></li>
                                        <li><a href="https://www.linkedin.com/in/pedrohrb/" target="_blank"><i className="fab fa-linkedin"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div id="rafael" if= "pessoa == 'rafael' || isMobile == true">
                                <div className="card">
                                    <img src={BackgroundCard} alt="background card" className="card-img"></img>
                                    <img src={Rafael} alt="imagem perfil rafael" className="img-perfil-sobre"></img>
                                    <h2>Rafael Rodrigues</h2>
                                    <p className="introducao">Sou Rafael</p>

                                    <ul className="redes-sociais">
                                        <li><a href="https://github.com/rafael-rodrigues-santos" target="_blank"><i className="fab fa-github"></i></a></li>
                                        <li><a href="mailto:rafaelrodrigues_@outlook.com"><i className="fas fa-envelope"></i></a></li>
                                        <li><a href="https://www.linkedin.com/in/rafael-rodrigues-santos/" target="_blank"><i className="fab fa-linkedin"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div id="thiago" if= "pessoa == 'thiago' || isMobile == true">
                                <div className="card">
                                    <img src={BackgroundCard} alt="background card" className="card-img"></img>
                                    <img src={Thiago} alt="imagem perfil thiago" className="img-perfil-sobre"></img>
                                    <h2>Thiago Dutra</h2>
                                    <p className="introducao">Oi! Sou Thiago</p>

                                    <ul className="redes-sociais">
                                        <li><a href="https://github.com/thiagosilvadtr" target="_blank"><i className="fab fa-github"></i></a></li>
                                        <li><a href="mailto:"><i className="fas fa-envelope"></i></a></li>
